var Particles = /** @class */ (function () {
    ...
    Particles.prototype.update = function (canvasHeight, playerX) {
        var starPositionsLength = this.starPositions.length;
        for (var sp = 0; sp < starPositionsLength; sp++) {
    ...
    Particles.prototype.renderStarPositions = function (ctx) {
